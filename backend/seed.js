...
const products = [
  {
    name: 'Issiqxona plyonkasi 120 mkm (3 qatlamli)',
    description: 'UV-barqaror, uch qatlamli polietilen plyonka. O\'zbekistonda birinchi bo\'lib ishlab chiqarilgan 12 metrgacha kenglikdagi issiqxona qoplamasi.',
    price: 45000, category: 'Issiqxona plyonkasi', image: '', stock: 200,
    thickness: 120, width: 12, length: 50, uvProtection: true
  },
  {
    name: 'Issiqxona plyonkasi 150 mkm (3 qatlamli)',
    description: 'Qalinlashtirilgan issiqxona plyonkasi. Yuqori darajada issiqlik saqlash va UV himoya. Katta issiqxonalar uchun.',
    price: 55000, category: 'Issiqxona plyonkasi', image: '', stock: 150,
    thickness: 150, width: 12, length: 50, uvProtection: true
  },
  {
    name: 'Issiqxona plyonkasi 100 mkm (iqtisodiy)',
    description: 'Iqtisodiy variant. Kichik va o\'rta issiqxonalar uchun maqbul. UV stabilizatorli.',
    price: 32000, category: 'Issiqxona plyonkasi', image: '', stock: 300,
    thickness: 100, width: 6, length: 100, uvProtection: true
  },
  {
    name: 'Termo-usadoz plyonka 30 mkm',
    description: 'Sanoat qadoqlash uchun termo-usadoz plyonka. Issiq bilan ishlov berilganda qisqarib, mahsulotni mustahkam o\'raydi.',
    price: 18000, category: 'Termo-usadoz plyonka', image: '', stock: 500,
    thickness: 30, width: 0.5, length: 200, uvProtection: false
  },
  {
    name: 'Termo-usadoz plyonka 50 mkm (mustahkam)',
    description: 'Qalinlashtirilgan termo-usadoz plyonka. Og\'ir yuklar va paletalarni o\'rash uchun. Omborxona va logistika uchun.',
    price: 25000, category: 'Termo-usadoz plyonka', image: '', stock: 400,
    thickness: 50, width: 0.5, length: 150, uvProtection: false
  },
  {
    name: 'Polietilen paket (umumiy maqsad)',
    description: 'Ko\'p maqsadli polietilen paketlar. Mahsulotlarni saqlash va tashishda ishlatiladi. Turli hajm va qalinlikda.',
    price: 8000, category: 'Polietilen paketlar', image: '', stock: 1000,
    thickness: 40, width: 0.4, length: 0.6, uvProtection: false
  },
  {
    name: 'Vakuumli pul qadoqlash paketi',
    description: 'Banklar uchun maxsus mustahkam qatlamga ega vakuum usuli bilan pulni qadoqlash sumkasi.',
    price: 15000, category: 'Polietilen paketlar', image: '', stock: 600,
    thickness: 80, width: 0.3, length: 0.4, uvProtection: false
  },
  {
    name: 'PET kapsulalar (suv uchun, 1L)',
    description: 'Suv idishlari uchun egiluvchan polikarbonat kapsula. 1 litrli idishlar uchun ~28 gramm.',
    price: 5000, category: 'PET kapsulalar', image: '', stock: 2000,
    thickness: 28, width: 1, length: 1, uvProtection: false
  },
  {
    name: 'PET kapsulalar (yog\' uchun, 5-10L)',
    description: 'Yog\' idishlari uchun mustahkam PET kapsula. 5-10 litr hajmdagi idishlar uchun 84-140 gramm.',
    price: 12000, category: 'PET kapsulalar', image: '', stock: 1500,
    thickness: 84, width: 1, length: 10, uvProtection: false
  },
  {
    name: 'Roof Cover (gidroizolyatsiya)',
    description: '"Roof Cover" — tom yopish va gidroizolyatsiya uchun rulonli material. Issiq va sovuqqa chidamli.',
    price: 35000, category: 'Tom yopish materiallari', image: '', stock: 250,
    thickness: 3, width: 1, length: 15, uvProtection: false
  },
  {
    name: 'Roof Cover (alyuminiyli)',
    description: 'Alyuminiy folga qatlami bilan kuchaytirilgan tom yopish materiali. Yuqori suv va issiqlikka chidamli.',
    price: 48000, category: 'Tom yopish materiallari', image: '', stock: 200,
    thickness: 4, width: 1.5, length: 15, uvProtection: false
  },
  {
    name: 'Bitum-polimer mastika (20 kg)',
    description: 'Gidroizolyatsiya va hermetizatsiya ishlari uchun maxsus polimer aralashma. Qurilish va ta\'mirlash uchun.',
